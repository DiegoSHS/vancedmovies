...
export const SvgPropsMapper: React.FC<IconSvgProps> = ({
  size = 36,
  children,
  ...props
}) => {
...
export const SquaresIcon: React.FC<IconSvgProps> = (props) => (
  <SvgPropsMapper {...props}>
...
export const EllipsisIcon: React.FC<IconSvgProps> = (props) => (
  <SvgPropsMapper {...props}>
