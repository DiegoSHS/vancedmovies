...
interface MovieModalProps {
  ...
  setHashes: React.Dispatch<
    React.SetStateAction<import("../../domain/entities/Hashes").HashResult[]>
  >;
}

export const MovieCommunityModal: React.FC<MovieModalProps> = ({
  isOpen,
  onOpenChange,
  setHashes,
}) => {
    ...
    <Modal.Backdrop isOpen={isOpen} onOpenChange={onOpenChange}>
      <Modal.Container>
        <Modal.Dialog>
          <Modal.CloseTrigger />
          <Modal.Header>
            <Modal.Heading>Añade un nuevo torrent</Modal.Heading>
          </Modal.Header>
          <Modal.Body>
